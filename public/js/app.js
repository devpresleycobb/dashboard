...
var topCarousel = function topCarousel() {
  ...
  var options = _objectSpread(_objectSpread({}, baseOptions), {}, {
    ...
    responsive: [{
      breakpoint: 1300,
      settings: _objectSpread(_objectSpread({}, baseOptions), {}, {
        slidesToShow: 2
      })
    }, {
      breakpoint: 800,
  ...
  var rightArrow = function rightArrow() {
    return $('.top-carousel').slick('slickNext');
  };

  var leftArrow = function leftArrow() {
    return $('.top-carousel').slick('slickPrev');
  };
...
var middleCarousel = function middleCarousel() {
  var baseOptions = {
    infinite: true,
    autoplay: false,
    arrows: false,
  ...
  var rightArrow = function rightArrow() {
    return $('.middle-carousel').slick('slickNext');
  };

  var leftArrow = function leftArrow() {
    return $('.middle-carousel').slick('slickPrev');
  };
